...
import { TAB_BAR_STICKY_TOP } from '@/utils/scrollToSection'
    ...
    >
      <div className="max-w-7xl mx-auto px-3 md:px-8">
        <div
          ...
          className="flex gap-2 overflow-x-auto snap-x snap-mandatory py-3 scrollbar-none md:justify-center md:flex-wrap md:overflow-visible"

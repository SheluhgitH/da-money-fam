        ...
        >
          {items.map((item, index) => (
            <motion.div
              ...
              className={`relative shrink-0 w-[42vw] sm:w-48 md:w-56 snap-center overflow-hidden rounded-2xl border border-gold/20 bg-black ${
                ASPECT_CLASS[item.aspect_ratio] || ASPECT_CLASS['9:16']
              }`}
            >
              <video
                src={item.videoUrl}
